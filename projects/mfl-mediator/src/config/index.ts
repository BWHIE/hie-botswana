          ...
          defaultChannelConfig: [
            {
              ...
              requestBody: true,
              responseBody: true,
              name: "MFL - FHIR Passthrough",
              description: "Get or Post a new FHIR Resource to the MFL",
              urlPattern: "^/MFL/fhir.*$",
              routes: [
                {
                  type: "http",
                  ...
                  name: "MFL - Get/Create/Update Resource",
                  secured: false,
                  host: "mfl-api",
                  port: 3000,
                  path: "",
                  pathTransform: "s/MFL\\/fhir/fhir/g",
                  primary: true,
                  username: "",
                  password: "",
                },
            ...
            },
            {
              ...
              requestBody: true,
              responseBody: true,
              description: "Get or Update the MFL Bundles",
              urlPattern: "^/MFL/.*$",
              routes: [
                {
                  type: "http",
