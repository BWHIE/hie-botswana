...
export class BDRSController {
    ...
    async getBirthByID(
        ...
        try {
            ...
            const bundle = await this.bdrsService.getBirthByID(idArray, new Pager(pageNum, pageSize));
            return bundle;
    ...
    async getDeathByID(
        ...
        try {
            ...
            const idArray = Array.isArray(ID) ? ID : [ID];
            const bundle = await this.bdrsService.getDeathByID(idArray, new Pager(pageNum, pageSize));
            return bundle;
    ...
    async findBirthByFullName(
        ...
        try {
            if (!givenNames || !lastName) {
                throw new BadRequestException('Both givenNames and lastName parameters are required');
            }
            ...
            const result = await this.bdrsService.findBirthByFullName(givenNames, lastName, new Pager(pageNum, pageSize));
            if (result) {
                return result;
            } else {
    ...
    async findDeathByFullName(
        ...
        try {
            ...
            const result = await this.bdrsService.findDeathByFullName(givenNames, lastName, new Pager(pageNum, pageSize));
            if (result) {
                return result;
            } else {
                return `No record with Name '${givenNames} ${lastName}' found.`;
    ...
    async findBirthByLastName(
        ...
        try {
            ...
            const result = await this.bdrsService.findBirthByLastName(LastName, new Pager(pageNum, pageSize));
            if (result) {
                return result;
            } else {
    ...
    async findDeathByLastName(
        ...
        try {
            ...
            const result = await this.bdrsService.findDeathByLastName(lastName, new Pager(pageNum, pageSize));
            if (result) {
                return result;
            } else {
                return `No record with LastName '${lastName}' found.`;
    ...
    async birthsByDate(
        ...
        try {
            ...
            const result = await this.bdrsService.findBirthsByDate(start, end, new Pager(pageNum, pageSize));
            if (result) {
                return result;
            } else {
    ...
    async deathsByDate(
        ...
        try {
            ...
            let start = new Date(startDate);
            let end = endDate ? new Date(endDate) : new Date();
            const result = await this.bdrsService.findDeathsByDate(start, end, new Pager(pageNum, pageSize));
            if (result) {
                return result;
            } else {
                return 'No record with parameters provided found.';
