...
describe('BDRSService', () => {
  ...
  it('should return empty birth records by full name ', async () => {
    ...
    // Act
    const result = await bdrsService.findBirthByFullName(
      firstName,
      lastName,
      pager,
    );
    ...
    expect(mockBirthRepository.getByName).toHaveBeenCalledWith(
      firstName,
      lastName,
      pager,
    );
  ...
  it('should return empty birth records by last name ', async () => {
    ...
    // Act
    const result: BirthRecord[] = await bdrsService.findBirthByLastName(
      lastName,
      pager,
    );
    ...
    // Assert
    expect(result).toEqual(mockedBirthRecords);
    expect(mockBirthRepository.getByLastName).toHaveBeenCalledWith(
      lastName,
      pager,
    );
  });
  ...
  it('should return birth records by Date Range ', async () => {
    ...
    // Act
    const result: BirthRecord[] = await bdrsService.findBirthsByDate(
      startDate,
      endDate,
      pager,
    );
  ...
  it('should return empty death records by full name ', async () => {
    ...
    // Act
    const result = await bdrsService.findDeathByFullName(
      firstName,
      lastName,
      pager,
    );
    ...
    expect(mockDeathRepository.getByName).toHaveBeenCalledWith(
      firstName,
      lastName,
      pager,
    );
  ...
  it('should return empty death records by last name ', async () => {
    ...
    // Assert
    expect(mockedDeathRecords).toEqual(result);
    expect(mockDeathRepository.getByLastName).toHaveBeenCalledWith(
      lastName,
      pager,
    );
  });
  ...
  it('should return death records by Date Range ', async () => {
    ...
    // Act
    const result = await bdrsService.findDeathsByDate(
      startDate,
      endDate,
      pager,
    );
    ...
    // Assert
    expect(mockedDeathRecords).toEqual(result);
    expect(mockDeathRepository.findDeathsByDate).toHaveBeenCalledWith(
      startDate,
      endDate,
      pager,
    );
