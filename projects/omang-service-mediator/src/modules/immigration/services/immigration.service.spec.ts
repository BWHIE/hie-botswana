...
mockImmigrationRecord.ENTRY_PLACE_NAME =
...
mockImmigrationRecordOne.ENTRY_PLACE_NAME =
...
mockImmigrationRecordTwo.ENTRY_PLACE_NAME =
...
describe('ImmigrationService', () => {
  ...
  it('should return empty Immigration records By ID ', async () => {
    ...
    const result: ImmigrationRecord[] =
      await immigrationService.getByPassportNo([id], pager);
  ...
  it('should return empty Immigration records By Birth Date Range ', async () => {
    ...
    // Act
    const result: ImmigrationRecord[] =
      await immigrationService.findByBirthDate(startDate, endDate, pager);

    // Assert
    expect(result).toEqual([]);
    expect(mockImmigrationRepository.findByBirthDate).toHaveBeenCalledWith(
      startDate,
      endDate,
      pager,
    );
  ...
  it('should return Empty Immigration records By Entry Date Range ', async () => {
    ...
    // Act
    const result: ImmigrationRecord[] =
      await immigrationService.findByEntryDate(startDate, endDate, pager);

    // Assert
    expect(result).toEqual([]);
    expect(mockImmigrationRepository.findByEntryDate).toHaveBeenCalledWith(
      startDate,
      endDate,
      pager,
    );
  ...
  it('should return Empty Immigration records By Passport Expiry Date Range ', async () => {
    ...
    // Act
    const result: ImmigrationRecord[] =
      await immigrationService.findByPassportExpiryDate(
        startDate,
        endDate,
        pager,
      );
    ...
    expect(result).toEqual([]);
    expect(
      mockImmigrationRepository.findByPassportExpiryDate,
    ).toHaveBeenCalledWith(startDate, endDate, pager);
  });
  ...
  it('should return empty Immigration records By Country', async () => {
    ...
    // Act
    const result: ImmigrationRecord[] = await immigrationService.findByCountry(
      country,
      pager,
    );
    ...
    // Assert
    expect(result).toEqual([]);
    expect(mockImmigrationRepository.findByCountry).toHaveBeenCalledWith(
      country,
      pager,
    );
  });
  ...
  it('should return empty Immigration records By Sex', async () => {
    ...
    // Act
    const result: ImmigrationRecord[] = await immigrationService.findBySex(
      gender,
      pager,
    );
    ...
    // Assert
    expect(result).toEqual([]);
    expect(mockImmigrationRepository.findBySex).toHaveBeenCalledWith(
      gender,
      pager,
    );
  });
  ...
  it('should return empty Immigration records By Last Name', async () => {
    ...
    // Act
    const result: ImmigrationRecord[] = await immigrationService.getByLastName(
      lastName,
      pager,
    );
    ...
    // Assert
    expect(result).toEqual([]);
    expect(mockImmigrationRepository.getByLastName).toHaveBeenCalledWith(
      lastName,
      pager,
    );
  });
  ...
  it('should return empty Immigration records By Full Name', async () => {
    ...
    // Act
    const result: ImmigrationRecord[] =
      await immigrationService.getByFullNameNonFHIR(firstName, lastName, pager);

    // Assert
    expect(result).toEqual([]);
    expect(mockImmigrationRepository.getByName).toHaveBeenCalledWith(
      firstName,
      lastName,
      pager,
    );
  ...
  it('should return Immigration records By Full Name', async () => {
    ...
    expect(
      mockImmigrationRepository.getByNameWithMiddleName,
    ).toHaveBeenCalledWith(theFirstName, theMiddleName, lastName, pager);
  });
  ...
  it('should return empty Immigration records By Full Name in FHIR Format', async () => {
    ...
    // Act
    const result: fhirR4.Bundle = await immigrationService.getByFullName(
      firstName,
      lastName,
      pager,
    );
