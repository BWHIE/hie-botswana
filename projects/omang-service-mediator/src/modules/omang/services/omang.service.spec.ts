...
describe('OmangService', () => {
  ...
  it('should return Omang records by ID in FHIR format ', async () => {
    ...
    mockEntry.fullUrl =
      'http://moh.bw.org/ext/identifier/omangPatient210711926';
  ...
  it('should return empty Omang records by Changed Date Range in Non FHIR format ', async () => {
    ...
    // Act
    const result: Omang[] = await omangService.findOmangByChangeDateNonFHIR(
      startDate,
      endDate,
      pager,
    );
    ...
    // Assert
    expect(result).toEqual([]);
    expect(mockOmangRepository.getChanged).toHaveBeenCalledWith(
      startDate,
      endDate,
      pager,
    );
  ...
  it('should return empty Omang records by Changed Date Range in FHIR format ', async () => {
    ...
    // Act
    const result: fhirR4.Bundle = await omangService.findOmangByChangeDate(
      startDate,
      endDate,
      pager,
    );
  ...
  it('should return Omang records by Changed Date Range in FHIR format ', async () => {
    ...
    mockEntryOne.fullUrl =
      'http://moh.bw.org/ext/identifier/omangPatient210713925';
    mockEntryOne.resource = patientOne;

    const mockEntryTwo: fhirR4.BundleEntry = new fhirR4.BundleEntry();

    mockEntryTwo.fullUrl =
  ...
  it('should return empty Omang records by Deceased Date Range in Non FHIR format ', async () => {
    ...
    // Act
    const result: Omang[] = await omangService.findOmangByDeceasedDateNonFHIR(
      startDate,
      endDate,
      pager,
    );
    ...
    // Assert
    expect(result).toEqual([]);
    expect(mockOmangRepository.getDeceased).toHaveBeenCalledWith(
      startDate,
      endDate,
      pager,
    );
  ...
  it('should return empty Omang records by Deceased Date Range in FHIR format ', async () => {
    ...
    // Act
    const result: fhirR4.Bundle = await omangService.findOmangByDeceasedDate(
      startDate,
      endDate,
      pager,
    );
  ...
  it('should empty return Omang records by Last Name in Non FHIR format ', async () => {
    ...
    // Act
    const result: Omang[] = await omangService.findOmangByLastNameNonFHIR(
      lastName,
      pager,
    );
    ...
    // Assert
    expect(result).toEqual([]);
    expect(mockOmangRepository.getByLastName).toHaveBeenCalledWith(
      lastName,
      pager,
    );
  });
  ...
  it('should empty return Omang records by Last Name in FHIR format ', async () => {
    ...
    // Act
    const result: fhirR4.Bundle = await omangService.findOmangByLastName(
      lastName,
      pager,
    );
  ...
  it('should return Empty Omang records by Full Name in Non FHIR format ', async () => {
    ...
    // Act
    const result: Omang[] = await omangService.findOmangByFullNameNonFHIR(
      firstName,
      lastName,
      pager,
    );
    ...
    // Assert
    expect(result).toEqual([]);
    expect(mockOmangRepository.getByName).toHaveBeenCalledWith(
      firstName,
      lastName,
      pager,
    );
  ...
  it('should return Empty Omang records by Full Name in FHIR format ', async () => {
    ...
    // Act
    const result: fhirR4.Bundle = await omangService.findOmangByFullName(
      firstName,
      lastName,
      pager,
    );
