...
describe('PatientService', () => {
    ...
    beforeAll(async () => {
      const module: TestingModule = await Test.createTestingModule({
        imports: [UserModule, BirthModule,DeathModule,OmangModule,ImmigrationModule, MasterPatientIndexModule],
      ...
      patientService = new PatientService( mockMpi, mockOmangService, mockBdrsService, mockImmigrationService);
    ...
    it('should return FHIR Bundle by Searching Identifier and System for Immigration System', async () => {
        ...
        expect(mockImmigrationService.getPatientByPassportNumber).toHaveBeenCalledWith(id,new Pager(1, 1));
    ...
    it('should return FHIR Bundle by Searching Identifier and System for Omang System ', async () => {
      ...
      expect(result.type).toEqual(mockBundle.type);
      expect(result.total).toEqual(mockBundle.total);
      expect(mockOmangService.getOmangByID).toHaveBeenCalledWith([id],new Pager(1, 1));
  ...
  it('should return FHIR Bundle by Searching Identifier and System for BDRS system ', async () => {
    ...
    expect(result.type).toEqual(mockBundle.type);
    expect(result.total).toEqual(mockBundle.total);
    expect(mockBdrsService.getBirthByID).toHaveBeenCalledWith([id],new Pager(1, 1));
  ...
  it('should return FHIR Bundle by Full Name for Immigration System', async () => {
    ...
    // Act
    const result = await patientService.getPatientByFullName(firstName, lastName, system, pager);
    ...
    expect(result.type).toEqual(mockBundle.type);
    expect(result.total).toEqual(mockBundle.total);
    expect(mockImmigrationService.getByFullName).toHaveBeenCalledWith(firstName, lastName, pager);
  ...
  it('should return FHIR Bundle by Full Name for Omang System', async () => {
    ...
    expect(result.type).toEqual(mockBundle.type);
    expect(result.total).toEqual(mockBundle.total);
    expect(mockOmangService.findOmangByFullName).toHaveBeenCalledWith(firstName, lastName, pager);
  ...
  it('should return FHIR Bundle by Full Name for BDRS System', async () => {
    ...
    expect(result.type).toEqual(mockBundle.type);
    expect(result.total).toEqual(mockBundle.total);
    expect(mockBdrsService.findBirthByFullNameFHIR).toHaveBeenCalledWith(firstName, lastName, pager);
  ...
  it('should return an error by Full Name for unexisting system ', async () => {
    ...
    let result;
    try {
       result = await patientService.getPatientByFullName(firstName, lastName, system, pager);
    } catch (error) {
       result = error;
    }
