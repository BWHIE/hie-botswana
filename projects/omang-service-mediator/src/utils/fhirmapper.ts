...
export function mapImmigrationRecordToFhirPatient(
...
export function mapBirthDeathRecordToFhirPatient(
  br: BirthDeathRecord,
): fhirR4.Patient | null {
...
export function mapImmigrationRecordToSearchBundle(
...
export function mapDeathRecordsToSearchBundle(
  records: DeathRecord[],
): fhirR4.Bundle {
  const searchBundle: fhirR4.Bundle = FhirAPIResponses.RecordInitialized;
...
export function mapBirthecordToFhirPatient(
...
export function mapBirthRecordsToSearchBundle(
  records: BirthRecord[],
): fhirR4.Bundle {
  const searchBundle: fhirR4.Bundle = FhirAPIResponses.RecordInitialized;
